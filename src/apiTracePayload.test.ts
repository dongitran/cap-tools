...
describe('apiTracePayload', () => {
  it('parses raw drained runtime events without masking header, query, or body values', () => {
  ...
  it('ignores malformed events and truncates long previews', () => {
    const parsed = parseApiTraceDrainResult(
      {
        events: [
          null,
